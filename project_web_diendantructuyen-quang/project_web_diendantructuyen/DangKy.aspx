<%@ Page Title="Đăng Ký" Language="C#" MasterPageFile="~/MasterPage/Client.Master" AutoEventWireup="true" CodeBehind="DangKy.aspx.cs" Inherits="project_web_diendantructuyen.DangKy" %>
             ...
             <div class="col-s-12 col-m-6">
                <div class="container">
                    ...
                    <div class="button_process1">
                        <asp:Button   runat="server" class="btn btn-primary" ID="btnRegister" Text="Đăng Ký" OnClick="btn_dangky"  />
                    </div>
                    <br/>
                      <%--Thông báo--%>
                    <br/>
